    ...
    crossref:
      custom:
        - key: fil
          ...
          caption-prefix: File
    notebook-view:
      - notebook: files/dmslogo.ipynb
        title: "dmslogo (Jupyter)"
        url: https://www.github.com/meganstumpf/chikvdms-mAb-paper/quarto_readme_files/dmslogo.ipynb"
    notebook-links: true
...
samples <- read.csv("~/git/chikvdms-mAb-paper/quarto_readme_files/files/samples_12122022.txt", header = FALSE, sep = "\t")
...
samples <- read.csv("~/git/chikvdms-mAb-paper/quarto_readme_files/files/samples_06132023.txt", header = FALSE, sep = "\t")
print(row.names = FALSE, unname(samples), right = FALSE)
```
...
samples <- read.csv("~/git/chikvdms-mAb-paper/quarto_readme_files/files/samples_08012023.txt", header = FALSE, sep = "\t")
print(row.names = FALSE, unname(samples), right = FALSE)
```
...
library(knitr)
batchfile <- read.csv("~/git/chikvdms-mAb-paper/quarto_readme_files/files/batchfile.csv")
kable(batchfile)
```
...
<div style="padding: 15px 0px 15px 0px;">
  ...
  [View the Jupyter Notebook as HTML](files/dmslogo.html)
...
![](dmslogo_files/dmslogo_22_1.png)
...
![](dmslogo_files/dmslogo_24_1.png)
...
![](dmslogo_files/dmslogo_26_1.png)
...
![](dmslogo_files/dmslogo_28_1.png)
...
![](dmslogo_files/dmslogo_29_0.png)
...
![](dmslogo_files/dmslogo_30_1.png)
...
![](dmslogo_files/dmslogo_32_1.png)
...
![](dmslogo_files/dmslogo_34_1.png)
